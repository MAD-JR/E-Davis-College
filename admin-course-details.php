                                    ...
                                    <form action="addcoursecode.php" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="cid" class="validate" required disabled>
                                                <label class="">Course ID</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" name="cname" value="<?php echo $row['COURSE_NAME']; ?>" class="validate" required>
                                                <label class="">Course Name</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="desc" value="<?php echo $row['DESCR']; ?>" class="validate" required>
                                                <label class="">Course Description</label>
                                            </div>
                                            
                                            <div class="input-field col s6">
                                                <select name="class" required>
                                                <option value="<?php echo $row['CLASS']; ?>" disabled selected></option>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="text" name="require" value="<?php echo $row['REQUIRE']; ?>" class="validate" required>
                                                <label class="">Course Requirements</label>
                                            </div>
                                            
                                            <div class="input-field col s6">
                                                <input type="text" name="resource" value="<?php echo $row['RESOURCE']; ?>" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="file-field input-field col s12">
                                                <div class="btn admin-upload-btn">
                                                    ...
                                                    <input class="validate" type="file" name="image">
                                                </div>
                                                <div class="file-path-wrapper">
                                                    <input class="file-path validate" type="text" name="image" placeholder="Course Banner Image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
