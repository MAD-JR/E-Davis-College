...
<head>
    ...
    <meta name="description" content="Davis College is one of the best Davisal html template, it's suitable for all Davis websites like Davis College,college,school,online Davis,tution center,distance Davis,computer Davis">
    <meta name="keyword" content="Davis html template, Davis College template, college template, school template, online Davis template, tution center template">
        ...
        <div class="ed-mob-menu">
            <div class="ed-mob-menu-con">
                <div class="ed-mm-left">
                    <div class="wed-logo">
                        <a href="#"><img src="images/logo1.png" alt="" />
                        </a>
                    </div>
                </div>
                <ul>
        ...
        <div class="top-logo" data-spy="affix" data-offset-top="250">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <div class="wed-logo">
                            <a href="index.php"><img src="images/logo1.png" alt="" />
                            </a>
                        </div>
                        <div class="main-menu">
                            <ul>
            ...
            <div class="row">
                <div class="cor about-sp">
                    <div class="ed-about-tit">
                        <div class="con-title">
                            <h2>About our Model</span></h2>
                            <p>Davis College educates future leaders to champion opportunity and sustainability in solving the world’s most pressing challenges.</p>
                        </div>
                    </div>
            ...
            <div class="log-in-pop">
                ...
                <div class="log-in-pop-right">
                    ...
                    <form class="s12" action="logincode.php" method="POST">
                        ...
                        <div>
                            <div class="input-field s12">
                                <input type="hidden" name="status" value="Student" class="validate">
                                <label>Status</label>
                            </div>
                        </div>
                        <div>
                            <div class="input-field s4">
                                <input type="submit" name="loginbtn" value="Login" class="waves-effect waves-light log-in-btn"> </div>
                        </div>
                    </form>
                </div>
            </div>
