                                ...
                                <div class="tab-inn">
                                    ...
                                    <div class="table-responsive table-desi">
                                        <?php
                                            ...
                                            $conn = mysqli_connect($servername, $username, $password, $dbname);
                                            $query = "SELECT * FROM users WHERE STATUS='Student' ORDER BY ID";
                                            $query_run = mysqli_query($conn, $query);
                                        ?>
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo '<img src="userimages/'.$row['PROFILE'].'" width="80px"; height="100px;">'?></td>
                                                    ...
                                                    <td><form action="admin-student-edit.php" method="POST">
