                                    ...
                                    <form action="addstudentcode.php" method="POST">
                                        <div class="row">
                                            <div class="input-field col s2">
                                                <input type="text" name="id" value="STU-" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="number" name="phone" value="" class="validate" required>
                                                <label class="">Phone number</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="email" name="email" class="validate" value="@daviscollege.com" required>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <input type="password" name="confirmpassword" value="" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="file-field input-field col s12">
                                                ...
                                                <div class="file-path-wrapper">
                                                    <input class="file-path validate" type="text" name="profile" placeholder="Profile image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="input-field col s6">
