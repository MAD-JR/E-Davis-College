                        ...
                        <ul>
                            <li>
                                <div class="dash-book dash-b-1">
                                    ...
                                    echo '<h4>'.$row.'</h4>';
                                    ?>
                                    <a href="admin-all-courses.php">View more</a>
                                </div>
                            </li>
                            <li>
                                <div class="dash-book dash-b-3">
                                    ...
                                    $conn = mysqli_connect($servername, $username, $password, $dbname);
                                    $query = "SELECT ID FROM users WHERE STATUS='Instructor' ORDER BY ID";
                                    $query_run = mysqli_query($conn, $query);
                                    ...
                                    echo '<h4>'.$row.'</h4>';
                                    ?>
                                    <a href="admin-user-all.php">View more</a>
                                </div>
                            </li>
                            <li>
                                <div class="dash-book dash-b-2">
                                    ...
                                    $conn = mysqli_connect($servername, $username, $password, $dbname);
                                    $query = "SELECT ID FROM users WHERE STATUS='Student' ORDER BY ID";
                                    $query_run = mysqli_query($conn, $query);
                                    ...
                                    echo '<h4>'.$row.'</h4>';
                                    ?>
                                    <a href="admin-student-all">View more</a>
                                </div>
                            </li>
                            <li>
                                <div class="dash-book dash-b-4">
                                    ...
                                    echo '<h4>'.$row.'</h4>';
                                    ?>
                                    <a href="admin-exam-all.php">View more</a>
                                </div>
                            </li>
                        </ul>
                    </div>
