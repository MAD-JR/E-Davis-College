    ...
    <div class="container-fluid sb1">
        <div class="row">
            ...
            <div class="col-md-2 col-sm-3 col-xs-6 sb1-1">
                ...
                <a href="admin.php" class="logo"><img src="images/logo1.png" alt="" />
                </a>
            </div>
            <!--== SEARCH ==-->
            ...
            <div class="col-md-2 col-sm-3 col-xs-6">
                <!-- Dropdown Trigger -->
                <a class='waves-effect dropdown-button top-user-pro' href='#' data-activates='top-menu'><img src="images/user/7.png" alt="" />My Account <i class="fa fa-angle-down" aria-hidden="true"></i>
                </a>
    ...
    <div class="container-fluid sb2">
        <div class="row">
            <div class="sb2-1">
                ...
                <div class="sb2-12">
                    <ul>
                        <li><img src="images/profile.jpg" alt="">
                        </li>
                        <li>
                                    ...
                                    <form action="updatestudent.php" method="POST">
                                        <div class="row">
                                            <div class="input-field col s2">
                                                <input type="text" name="id" value="STU-2" class="validate" required>
                                                <label class="">ID</label>
                                            </div>
                                            <div class="input-field col s5">
                                                <input type="text" name="fname" value="Aboubacar" class="validate" required>
                                                <label class="">First name</label>
                                            </div>
                                            <div class="input-field col s5">
                                                <input type="text" name="lname" value="HARIMENSHI" class="validate" required>
                                                <label class="">Last name</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="number" name="phone" value="0788656222" class="validate" required>
                                                <label class="">Phone number</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="email" name="email" class="validate" value="aharimenshi522@daviscollege.com" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                ...
                                                <option value="" disabled selected>Rwanda</option>
                                                <option value="Rwanda" name="country" required>Rwanda</option>
                                                <option value="Burundi" name="country" required>Burundi</option>
                                                <option value="DRC" name="country" required>DRC</option>
                                             </select>
                                            </div>
                                            <div class="input-field col s6">
                                                <select name="class" required>
                                                    <option value="" disabled selected>INS</option>
                                                    <option value="INS" name="class" required>INS</option>
                                                    <option value="BME" name="class" required>BME</option>
                                                    <option value="HTM" name="class" required>HTM</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="password" name="password" value="12345" class="validate" required>
                                                <label class="">Password</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="password" name="confirmpassword" value="12345" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="file-field input-field col s12">
                                                <div class="btn admin-upload-btn">
                                                    ...
                                                    <input class="validate" type="file" name="profile">
                                                </div>
                                                <div class="file-path-wrapper">
                                                    <input class="file-path validate" type="text" name="profile" value="zabi.jpg" placeholder="Profile image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="input-field col s6">
                                                <input type="hidden" name="status" value="Student" class="validate" required>
