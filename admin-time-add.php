                    ...
                    <div class="row">
						...
						<div class="box-inn-sp admin-form">
                                ...
                                <div class="tab-inn">
                                    ...
                                    ?>
                                    <form action="addtimecode.php" method="POST">
                                        <div class="row">
                                            ...
                                            <div class="input-field col s6">
                                                <h5>End time</h5>
                                                <input type="time" class="validate" name="endtime" required>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="1day" class="validate" required>
                                                <label class="">Monday</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" name="2day" class="validate" required>
                                                <label class="">Tuesday</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="3day" class="validate" required>
                                                <label class="">Wednesday</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" name="4day" class="validate" required>
                                                <label class="">Thursday</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="hidden" value="No Class" name="5day" class="validate">
