                        ...
                        <div class="box-inn-sp admin-form">
                                ...
                                <div class="tab-inn">
                                    ...
                                    <form action="addcoursecode.php" method="POST">
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="description" value="" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="input-field col s6">
                                                <input type="text" name="require" class="validate"  required>
                                                <label class="">Course Requirements</label>
                                            </div>
                                            <div class="input-field col s6">
                                                <input type="text" name="resource" value="" class="validate" required>
                                        ...
                                        <div class="row">
                                            <div class="file-field input-field col s12">
                                                ...
                                                <div class="file-path-wrapper">
                                                    <input class="file-path validate" type="text" name="image" placeholder="Course image">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
