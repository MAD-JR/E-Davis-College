									...
									<form action="addexam.php" method="POST">
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <input type="text" name="nexam" class="validate" required>
                                                <label class="">Main exam name</label>
                                            </div>
                                            <div class="input-field col s12">
                                                    <select name="course" required>
                                      <option value="" disabled selected>Select Course</option>
                                      <option value="Database Design" name="course">Database Design</option>
                                      <option value="IT Essential" name="course">IT Essential</option>
                                      <option value="Software Engineering" name="course">Software Engineering</option>
                                    </select>
                                                </div>
                                            <div class="input-field col s12">
                                                    <select name="class" required>
                                      <option value="" disabled selected>Select Class</option>
                                      <option value="INS" name="class">INS</option>
                                      <option value="BME" name="class">BME</option>
                                      <option value="HTM" name="class">HTM</option>
                                    </select>
                                                </div>
                                                <div class="input-field col s12">
                                                <textarea class="materialize-textarea" name="exam" required></textarea>
                                                <label>Exam:</label>
                                            </div>
											<div class="input-field col s12">
                                                <h5>Date</h5>
											...
											<div class="input-field col s12">
                                                <h5>Start time</h5>
                                                <input type="time" name="start" class="validate" required>
                                                
                                            </div>
											<div class="input-field col s12">
                                            <h5>End time</h5>
                                                <input type="time" name="end" class="validate" required>
                                            </div>
                                        </div>
                                            <div class="row">
                                                <div class="input-field col s12">
									  ...
									  <option value="Disable" name="status">De-Active</option>
									</select>
                                                </div>
                                            </div>
                                        <div class="row">
                                            <div class="input-field col s12">
                                                <i class="waves-effect waves-light btn-large waves-input-wrapper" style=""><input type="submit" name="addbtn" class="waves-button-input"></i>
                                            </div>
                                        </div>
                                    </form>
                                </div>
